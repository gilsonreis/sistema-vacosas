...
use app\models\search\ContribuicaoSearch;
...
/**
 * ContribuicoesController implements the CRUD actions for Contribuicao model.
 */
class ContribuicoesController extends Controller
{
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index'],
                        'roles' => ['contribuicoes/index'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['view'],
                        'roles' => ['contribuicoes/view'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['create'],
                        'roles' => ['contribuicoes/create'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['update'],
                        'roles' => ['contribuicoes/update'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['delete'],
                        'roles' => ['contribuicoes/delete'],
                    ],
                ],
    ...
    {
        $searchModel = new ContribuicaoSearch();
    ...
    {
        if (($model = Contribuicao::findOne($id)) !== null) {
            return $model;
        } else {
